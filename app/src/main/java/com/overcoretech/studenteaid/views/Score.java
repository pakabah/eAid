...
import com.overcoretech.studenteaid.adapter.ScoreAdapter;
 ...
 * {@link Score.OnFragmentInteractionListener} interface
...
public class Score extends android.support.v4.app.Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.relScore);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);
        ScoreAdapter scoreAdapter = new ScoreAdapter(initializeData());
        recyclerView.setAdapter(scoreAdapter);
        return view;
    }

    List<ScoreTemplate> initializeData()
    {
//        List<ScoreTemplate> scoreTemplates = new ArrayList<>();
//        scoreTemplates.add(new ScoreTemplate("Engineering Math", "25%", "2nd May, 2016"));
//        scoreTemplates.add(new ScoreTemplate("Engineering Math", "25%", "2nd May, 2016"));
//        scoreTemplates.add(new ScoreTemplate("Engineering Math", "25%", "2nd May, 2016"));
//        scoreTemplates.add(new ScoreTemplate("Engineering Math", "25%", "2nd May, 2016"));
//
