...
import com.overcoretech.studenteaid.adapter.CourseAdapter;
 ...
 * {@link Pasco.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Pasco#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Pasco extends android.support.v4.app.Fragment {
     ...
     * @return A new instance of fragment Pasco.
     */
    // TODO: Rename and change types and number of parameters
    public static Pasco newInstance(String param1, String param2) {
        Pasco fragment = new Pasco();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pasco, container, false);
        recyclerView = (RecyclerView) view.findViewById(R.id.relCourse);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);
        CourseAdapter courseAdapter = new CourseAdapter(initializeData(),getActivity().getApplicationContext());
