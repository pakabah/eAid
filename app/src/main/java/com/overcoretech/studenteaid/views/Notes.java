...
import com.overcoretech.studenteaid.adapter.NotesAdapter;
 ...
 */
public class Notes extends android.support.v4.app.Fragment  {
...
//        notesTemplates.add(new NotesTemplate("Year 4", "Numerical Analysis", "Dr. C.K Brown"));
//        notesTemplates.add(new NotesTemplate("Year 3", "Data Structures & Algorithms", "Prof. Adjei"));
//        notesTemplates.add(new NotesTemplate("Year 2", "Computer Vision", "Mrs Awua Amoah"));
